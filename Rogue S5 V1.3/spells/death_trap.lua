...
local menu_elements_death_trap =
{
    ...
    only_elite_or_boss = checkbox:new(true, get_hash(my_utility.plugin_label .. "death_trap_only_elite_or_boss_boolean")),
...
local function menu()
    ...
    if menu_elements_death_trap.tree_tab:push("Death Trap") then
        ...
        menu_elements_death_trap.only_elite_or_boss:render("Only Elite or Boss", "")
...
local function logics(entity_list, target_selector_data, best_target)
    ...
    local is_logic_allowed = my_utility.is_spell_allowed(
                ...
                death_trap_spell_id);
    if menu_elements_death_trap.only_elite_or_boss:get() then  -- Cette ligne a été corrigée
