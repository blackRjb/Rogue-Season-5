...
local menu_elements_shadow_clone_base =
{
    ...
    only_elite_or_boss = checkbox:new(true, get_hash(my_utility.plugin_label .. "shadow_clone_only_elite_or_boss_boolean")),
}
...
local function menu()
    ...
    if menu_elements_shadow_clone_base.tree_tab:push("Shadow Clone")then
        ...
        menu_elements_shadow_clone_base.only_elite_or_boss:render("Only Elite or Boss", "")
...
local function logics(target)
    ...
    if menu_elements_shadow_clone_base.only_elite_or_boss:get() then  -- Corrigé ici, tiret supprimé
