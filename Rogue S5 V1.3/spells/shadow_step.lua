...
local menu_elements_shadow_step_base =
{
    ...
    only_elite_or_boss = checkbox:new(true, get_hash(my_utility.plugin_label .. "shadow_step_only_elite_or_boss_boolean")),
...
local function menu()
    ...
    if menu_elements_shadow_step_base.tree_tab:push("Shadow Step")then
        ...
        menu_elements_shadow_step_base.only_elite_or_boss:render("Only Elite or Boss", "")
...
local function logics(entity_list, target_selector_data, best_target, closest_target)
    ...
    if menu_elements_shadow_step_base.only_elite_or_boss:get() then  
