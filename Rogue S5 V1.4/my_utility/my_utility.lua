...
function is_elite_or_boss(target)
    return target:is_elite() or target:is_boss() or target:is_champion()
end
...
local plugin_label = "BASE_ROGUE_PLUGIN_" -- add character name...
